...
public class Tuning {
        ...
        public static final PIDConfig SPATULA_PID = new PIDConfig(1.1, 0.005, 0, 0);
        ...
        //Drive Motors
        public static final PIDConfig FL_DRIVE_PID = new PIDConfig(0.1, 0.00, 0.0, 0.08);
        public static final PIDConfig FR_DRIVE_PID = new PIDConfig(0.1, 0.00, 0.0, 0.08);
        public static final PIDConfig BL_DRIVE_PID = new PIDConfig(0.1, 0.00, 0.0, 0.08);
        public static final PIDConfig BR_DRIVE_PID = new PIDConfig(0.1, 0.00, 0.0, 0.08);
        ...
        //Turn Motors
        public static final PIDConfig FL_TURN_PID = new PIDConfig(5, .0, 0.02);
        public static final PIDConfig FR_TURN_PID = new PIDConfig(5, .0, 0.02);
        public static final PIDConfig BL_TURN_PID = new PIDConfig(5, .0, 0.02);
        public static final PIDConfig BR_TURN_PID = new PIDConfig(5, .0, 0.02);
