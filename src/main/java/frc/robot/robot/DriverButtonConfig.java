...
public class DriverButtonConfig {
	public void initTeleop() {
		...
		new JoystickButton(ControlMap.CO_DRIVER_BUTTONS, 5)
				.onTrue(new SetSpatulaVoltageAndPos(0, 0.12).alongWith(new WaitCommand(0.3)).andThen(new SetSpatulaVoltageAndPos(2, 0.15)).andThen(new WaitCommand(0.3)).andThen(new SetSpatulaVoltageAndPos(0, 0.45)));
