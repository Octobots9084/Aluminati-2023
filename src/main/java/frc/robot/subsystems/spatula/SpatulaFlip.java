...
public class SpatulaFlip extends SubsystemBase {
    ...
    public SpatulaFlip() {
        ...
        this.spatulaMotor.setPeriodicFramePeriod(PeriodicFrame.kStatus0, 500);
        this.spatulaMotor.setPeriodicFramePeriod(PeriodicFrame.kStatus1, 500);
        this.spatulaMotor.setPeriodicFramePeriod(PeriodicFrame.kStatus2, 500);
        this.spatulaMotor.setPeriodicFramePeriod(PeriodicFrame.kStatus3, 500);
        this.spatulaMotor.setPeriodicFramePeriod(PeriodicFrame.kStatus4, 500);
        this.spatulaMotor.setPeriodicFramePeriod(PeriodicFrame.kStatus5, 20);
        this.spatulaMotor.setPeriodicFramePeriod(PeriodicFrame.kStatus6, 500);
