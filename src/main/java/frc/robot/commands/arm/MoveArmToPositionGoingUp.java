...
public class MoveArmToPositionGoingUp extends SequentialCommandGroup{
    ...
    public MoveArmToPositionGoingUp(ArmPositions aPosition) {
        ...
        addCommands(new MoveArmExtensionToPos(0),new MoveArmRotationToPos(aPosition.angle), new MoveArmExtensionToPos(aPosition.extension), new MoveArmWristToPos(aPosition.wrist));
    }
}
