...
public class MoveArmToPositionGoingDown extends SequentialCommandGroup{
    ...
    public MoveArmToPositionGoingDown(ArmPositions aPosition) {
        ...
        addCommands(new MoveArmExtensionToPos(0),new MoveArmWristToPos(aPosition.wrist),new MoveArmRotationToPos(aPosition.angle), new MoveArmExtensionToPos(aPosition.extension));
    }
}
