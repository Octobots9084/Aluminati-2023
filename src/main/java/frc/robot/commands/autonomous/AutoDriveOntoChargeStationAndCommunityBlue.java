...
*/
public class AutoDriveOntoChargeStationAndCommunityBlue extends SequentialCommandGroup {
    public AutoDriveOntoChargeStationAndCommunityBlue() {
        addCommands(
            new AutoConeTop(),
            new DriveBackwards(0.5).withTimeout(2),
            new DriveBackwards(0.1).withTimeout(2.8),
            new DriveForwards(0.0).withTimeout(2),
            new DriveForwards(0.5).withTimeout(2),
